...
reader_writer.o: reader_writer.cpp structures.h
	$(CC) -o $@ -cpp $< $(CFLAGS)
functions.o: functions.cpp structures.h functions.h robustPredicates.h
	$(CC) -o $@ -cpp $< $(CFLAGS)
...
main.o: main.cpp structures.h functions.h reader_writer.h robustPredicates.h
	$(CC) -o $@ -cpp $< $(CFLAGS)
