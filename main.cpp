...
// 	int d = 50; /* Initial Hilbert Variable*/
...
// 		struct Vertex *v0 = new Vertex (ligne+1,Data[3*i],Data[3*i+1],0.0,bits);
//      	S.push_back(v0);
...
//  	x0   = (ch1->x+ch4->x)/2.0;     
//  	y0    = (ch1->y+ch2->y)/2.0;
//  	xRed = (abs(ch1->x)+abs(ch4->x)) - x0;   
//  	xBlue = 0.0;
//  	yRed = 0.0;   
//  	yBlue = (abs(ch1->y)+abs(ch2->y)) - y0;
